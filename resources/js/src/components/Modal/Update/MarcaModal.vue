            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-4 flex flex-col items-center gap-2">
                    ...
                    <div class="text-center w-[75%]" v-if="fornecedores.length > 0">
                        ...
                        <select v-model="selectedFornecedor"
                    ...
                    <button v-if="fornecedores.length > 0" :disabled="!isFormValid" @click="submitForm"
...
export default {
    ...
    data() {
        return {
            name: this.marca.nome || '',
            segmento: this.marca.segmento || '',
            fornecedores: [],
            selectedFornecedor: this.marca.fornecedor_id ? this.marca.fornecedor_id : 'none'
        };
    },
    computed: {
        isFormValid() {
    ...
    methods: {
        ...
        async getFornecedores() {
            try {
                ...
                const fornecedor = this.fornecedores.find(f => f.name === this.marca.fornecedorNome);
                if (fornecedor) this.selectedFornecedor = fornecedor.id;
